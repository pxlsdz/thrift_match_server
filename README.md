...
结果如图：![image-20211210132628478](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112101326507.png)

### thrift简单语法介绍

#### 0.开发流程

1. 对接口进行描述，定义接口描述文件：`.thrift`文件，比如`match.thrift`
2. 使用`thrift`将接口的描述文件自动成对应语言的版本的代码，包括服务端和客户端
...
> 参考：打开[thrift官网](https://thrift.apache.org/)，在上方选择`Tutorial`项，查看thrift官方教程，点击下方的`tutorial.thrift`进入一个示例文件。
...
​		进入到`match_system`文件夹，创建`src`文件夹。在`src`下执行语句：
...
​		这样就会生成各种配置和连接文件，还有`代码框架`，只需要在框架中实现自己的业务即可。默认是放在`gen-cpp`，可以修改为`match_server`，以便更好的划分业务模块。
...
![image-20211210144631868](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112101446902.png)
...
3. 运行一下
   ...
   ![image-20211210193911626](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112101939724.png)
...
![image-20211210202640610](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112102030307.png)
...
![image-20211211003137397](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112110031487.png)
...
![image-20211211013906809](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112110139913.png)
...
5. 验证结果，登录到myserver服务器上查看存储的结果：
   ...
   cat result.txt
   ```
![image-20211211031148202](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112110311358.png)
...
![image-20211211161342894](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112111613019.png)
...
![image-20211211165140988](https://gitee.com/pxlsdz/blogImage/raw/master/img/202112111651123.png)
